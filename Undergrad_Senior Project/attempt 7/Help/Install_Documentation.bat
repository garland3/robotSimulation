...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Vendor Name" /mediaBookList "IGVC Robot Simulation Help File" /productName "IGVC Robot Simulation Help File" > NUL
...
COPY /Y "Documentation.msha" HelpContentSetup.msha
