namespace Attempt_7
{
    ...
    public class DrawImageAnalysis : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        {
            this.houghInfo = this.imageAnalysis.GetHoughInfo();
            this.lineArray = this.imageAnalysis.GetLineInfo();
       ...
       /// <param name="c">Color array to make into triangles</param>   
        ...
        {
            Game.GraphicsDevice.Viewport = this.viewPortList[0]; // Right center view port           
       ...
       /// <param name="houghInfo">Hough Information</param>
        ...
        private void AddHoughLinesColor()
        {
            ...
            {
                // Insert a hough line to from the start and stop positions calculated before. Red
                ...
                // Insert a line from 0,0 to closest point on hough line. This line will be perpendicular to hough line. Green
                this.InsertLine(this.houghLineStartandStopVectors[(i * 4) + 2], Vector3.Zero, new Color(0, 255 - (i * colorInc), 0));

                // Insert a line from bottom middle to the closest point on hough line. This line will be perpendicular to hough line. Blue
                //this.InsertLine(this.houghLineStartandStopVectors[(i * 4) + 3], new Vector3(this.screenWidth / 2, this.screenHeight, 0), new Color(0, 0, 255 - (i * colorInc)));
            }
        }       
